<?php
/**
 * cakemagic functions and definitions
 *
...
if ( ! function_exists( 'cakemagic_setup' ) ) :
	...
	function cakemagic_setup() {
		 ...
		 * If you're building a theme based on cakemagic, use a find and replace
		 * to change 'cakemagic' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'cakemagic' ),
		) );
